				...
				<el-form :model="formData" :inline="true" label-width="150px" label-position="right" class="form" ref="dataForm">
					...
					<el-form-item label="勘查单位">
						<div class="width240">
							...
							<el-input class="width240 select-input" v-model="formData.survey_info.corporation_name" readonly></el-input>
					...
					<el-form-item label="设计单位负责人">
						<div class="width240">
							...
							<el-input class="width240 select-input" v-model="formData.design_info.corporation_name" readonly></el-input>
					...
					<el-form-item label="施工单位">
						<div class="width240">
							...
							<el-input class="width240 select-input" v-model="formData.shigong_info.corporation_name" readonly></el-input>
